...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, description: 'Slot pagination page size', default: '10' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, description: 'Slot pagination page number', default: '1' }),

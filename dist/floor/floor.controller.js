...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'houseId', required: false, description: 'Floor filter with houseId' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, description: 'Floor pagination page size', default: '10' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, description: 'Floor pagination page number', default: '1' }),
